...
class ResourceController extends Controller
{
  ...
  public function moduleToTitle()
  {
    ...
    return ucwords($title."Management");
  }
  ...
  public function store()
  {
    ...
    $this->setModuleId($request->id);
    return redirect($this->getUrl())->withErrors(['success' => translate('Successfully created.')]);
  }
  ...
  public function update($id)
  {
    ...
    $this->setModuleId($id);
    return redirect($this->getUrl())->withErrors(['success' => translate('Successfully updated.')]);
  }
